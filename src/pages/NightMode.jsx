  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <section className="py-16 px-6">
        <h3 className="text-3xl font-bold mb-6 flex items-center gap-2 justify-center">
          <Moon className="w-6 h-6" /> Swiggy Night Mode
        </h3>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    <span className="text-yellow-400">🌙 Night Special</span>
                    <span className="text-swiggy-400 font-semibold">₹{item.price}</span>
                  </div>
                  <Button className="bg-swiggy-500 hover:bg-swiggy-600 w-full">
                    Order Now
                  </Button>
                </div>
              </CardContent>
      ...
      <section className="py-12 px-6 bg-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <h4 className="text-2xl font-bold mb-6 text-swiggy-400">Night Mode Benefits</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4">
              <div className="text-3xl mb-3">🕚</div>
              <h5 className="font-semibold mb-2">11 PM - 6 AM</h5>
              <p className="text-gray-300">Extended delivery hours for night owls</p>
            </div>
            <div className="p-4">
              <div className="text-3xl mb-3">💸</div>
              <h5 className="font-semibold mb-2">Special Discounts</h5>
              <p className="text-gray-300">Extra ₹20 off on all night orders</p>
            </div>
            <div className="p-4">
              <div className="text-3xl mb-3">🍕</div>
              <h5 className="font-semibold mb-2">Night Menu</h5>
              <p className="text-gray-300">Exclusive late-night food options</p>
            </div>
          </div>
        </div>
      </section>
